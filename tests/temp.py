...
url_4 = "https://maps.googleapis.com/maps/api/place/details/json?place_id=" + place_id + "&key=" + GOOGLE_PLACES_API_KEY + "&language=en&fields=formatted_address,address_components"
...
parsed_address = parse_address_components(response_4.json()['result']['address_components'])
